...
void cargarGruposEnVector(
    Consolidado vecGrupos[],
...
void mostrarVectorGruposConsolidado(
    Consolidado vecGrupos[],
    int lenConsolidado
) {
...
void ordenaVectorPorGrupo(Consolidado vecGrupos[], int lenConsolidado) {
    ...
    for (int i = 0; i < lenConsolidado; i++) {
        ...
        for (int j = i + 1; j < lenConsolidado; j++) {
            ...
            // strcoll() devuelve -1 si el 1� parametro es mayor que el 2�, 0 si el 1� es
            // igual al 2�, o 1 si el 1� mayor que el 2�. Lo hace caracter a caracter hasta
            // encontrar una diferencia o un nulo que es cuando retorna uno de los valores
            // mencionados.
            ...
            vecGrupos[j].letra)) > 0) {
                ...
                // esto va subiendo los nombres a la cabeza de la lista ordenado general para
                // todo
...
void ordenaVectorPorNombre(Consolidado vecGrupos[], int lenConsolidado) {
    ...
    for (int i = 0; i < lenConsolidado; i++) {
        ...
        for (int j = i + 1; j < lenConsolidado; j++) {
            ...
            if ((strcoll(/*1�*/
            vecGrupos[i].equipo.nombre,
            /*2�*/
            vecGrupos[j].equipo.nombre)) > 0) {
...
void ordenaVectorPorFederacion(Consolidado vecGrupos[], int lenConsolidado) { //Funcion que ordena el vector por federacion.
    ...
    for (int i = 0; i < lenConsolidado; i++) {
        ...
        for (int j = i + 1; j < lenConsolidado; j++) {
            ...
            if ((strcoll(/*1�*/
            vecGrupos[i].equipo.federacion,
            /*2�*/
            vecGrupos[j].equipo.federacion)) > 0) {
...
void mostrarOrdenamientos(Consolidado vecGrupos[], int lenConsolidado) {
    ...
    do {
        ...
        cout << "2-por Confederación." << endl;
        cout << "3-por Nombre." << endl;
        cout << "4-por Grupo y Federación." << endl;
        cout << "5-por Grupo, Federación y Nombre." << endl;
